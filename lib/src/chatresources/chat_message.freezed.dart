...
/// @nodoc
mixin _$ChatMessage {
  bool get showSender => throw _privateConstructorUsedError;
...
class _$ChatMessageCopyWithImpl<$Res, $Val extends ChatMessage>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      showSender: null == showSender
          ? _value.showSender
          : showSender // ignore: cast_nullable_to_non_nullable
              as bool,
      fromMe: null == fromMe
          ? _value.fromMe
...
class _$ChatMessageImpl implements _ChatMessage {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.showSender, showSender) ||
  ...
  int get hashCode => Object.hash(
      runtimeType, showSender, fromMe, sender, timestamp, message, child);
...
abstract class _ChatMessage implements ChatMessage {
  const factory _ChatMessage(
      ...
      final DateTime? timestamp,
      final String? message,
      final Widget? child}) = _$ChatMessageImpl;
